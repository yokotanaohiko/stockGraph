...
urlpatterns = patterns('',
    ...
    (r'^month_json/(?P<stock_num>\d{4})/$','itempage.views.ohlc_month'),
    (r'^week_json/(?P<stock_num>\d{4})/$','itempage.views.ohlc_week'),
    (r'^kabuka_add$','itempage.views.kabuka_add_today'),
    (r'^d3sample',"itempage.views.d3sample"),
)
